...
function getFormattedGlobalStats(stats) {
 ...
 for (var i = 0; i < stats.length; i++) {
  ...
  Row 4: ${statsRow.solvedRowCounts[4]} (${getPercent(statsRow.solvedRowCounts[4], total)})
  Row 5: ${statsRow.solvedRowCounts[5]} (${getPercent(statsRow.solvedRowCounts[5], total)})
  Row 6: ${statsRow.solvedRowCounts[6]} (${getPercent(statsRow.solvedRowCounts[6], total)})
